...
class _addItemState extends State<addItem> {
  ...
  void take()async{
   ...
   Reference storage = FirebaseStorage.instance.ref().child('HH');
            ...
            child: Column(
              children: [
                ElevatedButton(
                  ...
                  onPressed: (){showModalBottomSheet<ImageSource>(context: context, builder: (BuildContext context){
                    return  Container(
                      height: hi/4,
                      child: Column(
                          children: [
